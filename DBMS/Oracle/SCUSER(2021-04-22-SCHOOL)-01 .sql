...
CREATE TABLE tbl_student(
    st_num CHAR(5), -- 고정 문자열 CHAR
    st_name nVARCHAR2(20), -- 가변 문자열 nVAR
...
--      tbl_student 테이블의 모든데이터의 학번은 유일해야 한다
    ...
    CREATE TABLE tbl_student(
    st_num CHAR(5) UNIQUE NOT NULL, -- 고정 문자열 CHAR
    st_name nVARCHAR2(20) NOT NULL , -- 가변 문자열 nVAR
    st_dept nVARCHAR2(10),
    st_grade VARCHAR2(5), -- 숫자값을 입력, 숫자값을 문자형으로 인식하도록
    st_tel VARCHAR2(20), -- 000-0000-0000
    st_addr nVARCHAR2(125) 
...
--     UNIQUE는 매우 신중하게 선택해야 한다.
    ...
    VALUES('사회학과','이몽룡','00001');    

    INSERT INTO tbl_student( st_dept, st_name, st_num)
    VALUES('사회학과','이몽룡','00100');        
...
-- DBMS 에서는 기본키 제약조건을 설정하는 키워드가 별도로 있다
