...
CREATE TABLE tbl_score(
    sc_num CHAR(5) PRIMARY KEY, --고정
    sc_kor NUMBER NOT NULL, -- 숫자
...
-- 조회(인출)되고 있다
-- EQ JOIN(잠조 무결성이 보장되는 경우 사용하는 일반적인 JOIN)
SELECT SC.sc_num, 
    ST.st_name,
    ST.st_dept,
    SC.sc_kor,
